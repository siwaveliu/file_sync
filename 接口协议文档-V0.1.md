...
|-|-|-|
初始未完成|0.1|刘博强
补充未完成项，增加生产ID写入流程；增加程序烧写流程|0.2|刘博强
___
...
名称|帧内容
-|-
启动版本号测试|ED 00 07 ==03 03== 00 00 00  **{01}(X)** 00 EE 
停止版本号测试|ED 00 07 ==03 03== 00 00 00  **{02}(X)** 00 EE 
上报测试信息|ED 00 07 ==03 03== 00 00 00  **{03}(X)** ***{01}(DATA:0) {01}(1) {01}(2) {01}(3) {01}(4) {05}(5) {01}(6) {01}(7){05}(8) {05}(9) {01}(10) {02}(11) {51}(12) {01}(13) {01}(14) {19}(15) {01}(16) {03}(17) {28}(18) {01}(19) {12}(20) {06}(21)*** 00 EE
## 版本号验证
...
```
### 交互报文
SNR值类型int8；平坦度值类型32个int8；RSSI类型int16；
**DATA：**
|名称|列1|列2|列3|列4|
|-|-|-|-|-|
字节序号|0|1|2|3~34
第一行|SNR结果|SNR值|平坦度结果|平坦度数值
含义|SNR结果|SNR值|平坦度结果|平坦度数值
